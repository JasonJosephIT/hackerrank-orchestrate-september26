...
| Safety is checked on end-of-day balances (an intra-day check — debits before credits — exists behind `INTRADAY_CHECK`) | The intra-day variant explains sample 18's payday dining charge but loses two earliest-date and one spending-change match overall | intra-day check as default |
